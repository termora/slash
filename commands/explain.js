...
module.exports = class ExplainCommand extends SlashCommand {
    ...
    async run(ctx) {
        let sql = `select id, name, aliases, description, created, as_command from public.explanations where name ilike $1 or $1 ilike any(aliases) order by id desc limit 1`
